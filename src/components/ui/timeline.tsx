  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-5xl mb-4 text-white max-w-4xl font-black tracking-tighter uppercase">
          Mission Control
        </h2>
        <p className="text-neutral-400 text-sm md:text-base max-w-sm font-mono">
          Live tactical feed of global operations.
        </p>
      </div>
